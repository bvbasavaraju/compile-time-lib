...
template <typename... T>
struct pred_int : public std::false_type {};
template <typename... Ts>
struct pred_int<int, Ts...> : public std::true_type {};

template <typename... T>
struct pred_int_char : public std::false_type {};
template <typename... Ts>
struct pred_int_char<int, Ts...> : public std::true_type {};
template <typename... Ts>
struct pred_int_char<char, Ts...> : public std::true_type {};

template <typename... T>
struct pred_empty : public std::false_type {};
template <>
struct pred_empty<> : public std::true_type {};

template <typename... T>
struct pred_all : public std::true_type {};
template <>
struct pred_all<> : public std::false_type {};
...
TEST_F(list_test, push_front_test) {
    ...
    {  //{float, char, int}
        constexpr auto expect_true =
            std::is_same_v<float_char_int_list, ctl::list<float, char, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<float_char_int_list, ctl::list<int, char, float>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, push_back_test) {
    ...
    {  //{char, int, float}
        constexpr auto expect_true =
            std::is_same_v<char_int_float_list, ctl::list<char, int, float>>;
        EXPECT_TRUE(expect_true);
...
TEST_F(list_test, first_of_list) {
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<unsigned int, ctl::first_t<unsigned_int_in_list>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::list<>, ctl::first_t<unsigned_int_in_list>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, last_of_list) {
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<unsigned int, ctl::last_t<unsigned_int_in_list>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::list<>, ctl::last_t<unsigned_int_in_list>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, head_of_list) {
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<int, char>, ctl::head_t<heterogeneous_list_1>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<float, unsigned int, int, char>, ctl::head_t<merged_list>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<int, char, double, float>, ctl::head_t<merged_list2>>;
        EXPECT_TRUE(expect_true);
    ...
    using unsigned_int_in_list = ctl::list<unsigned int>;
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<unsigned int, ctl::head_t<unsigned_int_in_list>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, front_of_list) {
    ...
    using heterogeneous_list_1 = ctl::list<int, char, double>;
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::list<int, char>, ctl::front_t<heterogeneous_list_1>>;
        EXPECT_FALSE(expect_false);
    }
    ...
    using merged_list = ctl::push_front_t<heterogeneous_list_1, heterogeneous_list_2>;
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::list<float, unsigned int, int, char>, ctl::front_t<merged_list>>;
        EXPECT_FALSE(expect_false);
    }
    ...
    using merged_list2 = ctl::push_front_t<heterogeneous_list_2, heterogeneous_list_1>;
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::list<int, char, double, float>, ctl::front_t<merged_list2>>;
        EXPECT_FALSE(expect_false);
    }
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<unsigned int, ctl::front_t<unsigned_int_in_list>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::list<>, ctl::front_t<unsigned_int_in_list>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, pop_back_list) {
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<int, char>, ctl::pop_back_t<heterogeneous_list_1>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<float, unsigned int, int, char>, ctl::pop_back_t<merged_list>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<int, char, double, float>, ctl::pop_back_t<merged_list2>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<>, ctl::pop_back_t<unsigned_int_in_list>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<unsigned int, ctl::pop_back_t<unsigned_int_in_list>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, tail_of_list) {
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<char, double>, ctl::tail_t<heterogeneous_list_1>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<unsigned int, int, char, double>, ctl::tail_t<merged_list>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<char, double, float, unsigned int>, ctl::tail_t<merged_list2>>;
        EXPECT_TRUE(expect_true);
    ...
    using unsigned_int_in_list = ctl::list<unsigned int>;
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<unsigned int, ctl::tail_t<unsigned_int_in_list>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, back_of_list) {
    ...
    using heterogeneous_list_1 = ctl::list<int, char, double>;
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::list<char, double>, ctl::back_t<heterogeneous_list_1>>;
        EXPECT_FALSE(expect_false);
    }
    ...
    using merged_list = ctl::push_front_t<heterogeneous_list_1, heterogeneous_list_2>;
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::list<unsigned int, int, char, double>, ctl::back_t<merged_list>>;
        EXPECT_FALSE(expect_false);
    }
    ...
    using merged_list2 = ctl::push_front_t<heterogeneous_list_2, heterogeneous_list_1>;
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::list<char, double, float, unsigned int>, ctl::back_t<merged_list2>>;
        EXPECT_FALSE(expect_false);
    }
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<unsigned int, ctl::back_t<unsigned_int_in_list>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::list<>, ctl::back_t<unsigned_int_in_list>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, pop_front_list) {
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<char, double>, ctl::pop_front_t<heterogeneous_list_1>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<double, ctl::pop_front_t<heterogeneous_list_1>>;
        EXPECT_FALSE(expect_false);
    }
    ...
    using merged_list = ctl::push_front_t<heterogeneous_list_1, heterogeneous_list_2>;
    {
        constexpr auto expect_true = std::is_same_v<ctl::list<unsigned int, int, char, double>,
                                                    ctl::pop_front_t<merged_list>>;
        EXPECT_TRUE(expect_true);
    ...
    using merged_list2 = ctl::push_front_t<heterogeneous_list_2, heterogeneous_list_1>;
    {
        constexpr auto expect_true = std::is_same_v<ctl::list<char, double, float, unsigned int>,
                                                    ctl::pop_front_t<merged_list2>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::list<>, ctl::pop_front_t<unsigned_int_in_list>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<unsigned int, ctl::pop_front_t<unsigned_int_in_list>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, remove_type) {
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<after_remove_int, ctl::list<char, double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<after_remove_char, ctl::list<char, double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<after_remove_double, ctl::list<char, double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<after_remove_float, ctl::list<int, char, double, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<after_remove_float, ctl::list<char, double, int>>;
        EXPECT_FALSE(expect_false);
    }
...
TEST_F(list_test, remove_duplicates) {
    {
        ...
        constexpr auto expect_true =
            std::is_same_v<after_remove_duplicate, ctl::list<int, char, double>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<after_remove_duplicate, ctl::list<char, double, int>>;
        EXPECT_FALSE(expect_false);
    }
    ...
    {
        using multi_repeated_type =
            ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        using after_remove_duplicate = ctl::remove_duplicates_t<multi_repeated_type>;
        constexpr auto expect_true =
            std::is_same_v<after_remove_duplicate, ctl::list<char, int, double>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        using multi_repeated_type =
            ctl::list<int, int, int, char, char, char, double, double, double>;
        using after_remove_duplicate = ctl::remove_duplicates_t<multi_repeated_type>;
        constexpr auto expect_true =
            std::is_same_v<after_remove_duplicate, ctl::list<int, char, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<after_remove_duplicate, ctl::list<double, float, int>>;
        EXPECT_TRUE(expect_true);
...
TEST_F(list_test, reverse) {
    {
        ...
        constexpr auto expect_true =
            std::is_same_v<after_reverse, ctl::list<int, double, char, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<after_reverse, ctl::list<int, char, double, int>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        using after_reverse = ctl::reverse_t<list>;
        constexpr auto expect_true =
            std::is_same_v<after_reverse,
                           ctl::list<double, double, double, char, char, char, int, int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        using after_reverse = ctl::reverse_t<list>;
        constexpr auto expect_true =
            std::is_same_v<after_reverse, ctl::list<double, int, double, int, char, int, double,
                                                    int, char, int, char>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<after_reverse, ctl::list<char, int, char, int, double, int, char, int,
                                                    double, int, double>>;
        EXPECT_FALSE(expect_false);
    }
...
TEST_F(list_test, filter_only_ints) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_int, list>, ctl::list<int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_int, list>, ctl::list<int, int, int, int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_t<pred_int, list>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_int, L1, L2, L3>, ctl::list<int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        using L3 =
            ctl::list<double, int, char, int, float, int, char, int, double, char[3], double>;
        constexpr auto expect_true = std::is_same_v<ctl::filter_if_t<pred_int, L1, L2, L3>,
                                                    ctl::list<int, int, int, int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_int, L1, L2, L3>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_t<pred_int, L1, L2, L3>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, filter_only_ints_chars) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_int_char, list>, ctl::list<int, char, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_int_char, list>,
                           ctl::list<char, int, char, int, int, char, int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_int_char, list>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_t<pred_int_char, list>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        using L3 = ctl::list<void, int, char, char>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_int_char, L1, L2, L3>, ctl::list<int, char, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_t<pred_int_char, L1, L2, L3>, L1>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        using L3 =
            ctl::list<double, int, char, int, float, int, char, int, double, char[3], double>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_int_char, L1, L2, L3>,
                           ctl::list<char, int, char, int, int, char, int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        using L3 = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_int_char, L1, L2, L3>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_t<pred_int_char, L1, L2, L3>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, filter_none) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_empty, list>, ctl::list<>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_t<pred_empty, list>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        using L3 = ctl::list<void, int, char, char>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_t<pred_empty, L1, L2, L3>, ctl::list<>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_t<pred_empty, L1, L2, L3>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, filter_all) {
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_t<pred_all, list>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_t<pred_all, L1, L2, L3>, ctl::list<>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_t<pred_all, L1, L2, L3>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, filter_using_quoted_meta_function) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_qmf_t<quoted_int_char, list>, ctl::list<int, char, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_qmf_t<quoted_int_char, list>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_qmf_t<quoted_int_char, list>,
                           ctl::list<char, int, char, int, int, char, int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_qmf_t<quoted_int_char, list>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_qmf_t<quoted_int_char, list>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        using L3 = ctl::list<void, int, char, char>;
        constexpr auto expect_true =
            std::is_same_v<ctl::filter_if_qmf_t<quoted_int_char, L1, L2, L3>,
                           ctl::list<int, char, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_qmf_t<quoted_int_char, L1, L2, L3>, L1>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::filter_if_qmf_t<quoted_int_char, L1, L2, L3>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, drop) {
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::drop_t<list, count>, ctl::list<double, int>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        using count = std::integral_constant<uint32_t, 5>;
        constexpr auto expect_true = std::is_same_v<ctl::drop_t<list, count>,
                                                    ctl::list<int, char, int, double, int, double>>;
        EXPECT_TRUE(expect_true);
...
TEST_F(list_test, take) {
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::take_t<list, count>, ctl::list<double, int>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        using count = std::integral_constant<uint32_t, 5>;
        constexpr auto expect_true =
            std::is_same_v<ctl::take_t<list, count>, ctl::list<char, int, char, int, double>>;
        EXPECT_TRUE(expect_true);
...
TEST_F(list_test, repeat) {
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::repeat_t<list, count>, ctl::list<double, int>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        using count = std::integral_constant<uint32_t, 2>;
        constexpr auto expect_true =
            std::is_same_v<ctl::repeat_t<list, count>,
                           ctl::list<int, char, double, int, int, char, double, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true = std::is_same_v<
            ctl::repeat_t<list, count>,
            ctl::list<int, char, double, int, int, char, double, int, int, char, double, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::repeat_t<list, count>,
                           ctl::list<int, char, double, int, int, char, double, int, int, char,
                                     double, int, int, char, double, int, int, char, double, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::repeat_t<list, count>, ctl::list<int, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::repeat_t<list, count>, ctl::list<int, int, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::repeat_t<list, count>, ctl::list<int, int, int, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::repeat_t<list, count>, ctl::list<int, int, int, int, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::repeat_t<list, count>, ctl::list<int, int, int, int, int, int>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        constexpr auto expect_true = std::is_same_v<
            ctl::repeat_t<list, count>,
            ctl::list<char, int, char, int, double, int, char, int, double, int, double, char, int,
                      char, int, double, int, char, int, double, int, double>>;
        EXPECT_TRUE(expect_true);
...
TEST_F(list_test, from_integer_sequence) {
    {
        ...
        using from_seq = ctl::from_integer_sequence_t<seq, std::tuple>;

        constexpr auto expect_true = std::is_same_v<
            from_seq,
            std::tuple<
                std::integral_constant<unsigned int, 9>, std::integral_constant<unsigned int, 2>,
                std::integral_constant<unsigned int, 5>, std::integral_constant<unsigned int, 1>,
                std::integral_constant<unsigned int, 9>, std::integral_constant<unsigned int, 1>,
...

    {
        ...
        constexpr auto expect_true = std::is_same_v<
            from_seq, std::tuple<std::integral_constant<int, 0>, std::integral_constant<int, 1>,
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<from_seq, std::tuple<std::integral_constant<long unsigned int, 0>,
                                                ...
                                                std::integral_constant<long unsigned int, 4>,
                                                std::integral_constant<long unsigned int, 5>,
                                                std::integral_constant<long unsigned int, 6>,
                                                std::integral_constant<long unsigned int, 7>,
                                                std::integral_constant<long unsigned int, 8>,
                                                std::integral_constant<long unsigned int, 9>>>;
        EXPECT_TRUE(expect_true);
    }
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<from_seq,
                           ctl::list<std::integral_constant<int, 0>, std::integral_constant<int, 1>,
                                     std::integral_constant<int, 2>, std::integral_constant<int, 3>,
                                     std::integral_constant<int, 4>>>;
        EXPECT_TRUE(expect_true);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<from_seq, ctl::list<std::integral_constant<long unsigned int, 0>,
                                               std::integral_constant<long unsigned int, 1>,
                                               std::integral_constant<long unsigned int, 2>,
                                               std::integral_constant<long unsigned int, 3>,
                                               std::integral_constant<long unsigned int, 4>,
...
TEST_F(list_test, iota) {
    {
        ...
        constexpr auto expect_true = std::is_same_v<
            ctl::iota_t<count, std::tuple>,
            std::tuple<
                std::integral_constant<unsigned int, 0>, std::integral_constant<unsigned int, 1>,
                std::integral_constant<unsigned int, 2>, std::integral_constant<unsigned int, 3>,
                std::integral_constant<unsigned int, 4>, std::integral_constant<unsigned int, 5>,
                std::integral_constant<unsigned int, 6>>>;
        EXPECT_TRUE(expect_true);
    }

    {
        ...
        constexpr auto expect_true = std::is_same_v<
            ctl::iota_t<count, std::tuple>,
            std::tuple<std::integral_constant<int, 0>, std::integral_constant<int, 1>,
                       std::integral_constant<int, 2>, std::integral_constant<int, 3>,
                       std::integral_constant<int, 4>>>;
        EXPECT_TRUE(expect_true);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::iota_t<count, std::tuple>,
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::iota_t<count>,
                           ctl::list<std::integral_constant<int, 0>, std::integral_constant<int, 1>,
                                     std::integral_constant<int, 2>, std::integral_constant<int, 3>,
                                     std::integral_constant<int, 4>>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::iota_t<count>,
                           ctl::list<std::integral_constant<long unsigned int, 0>,
                                     std::integral_constant<long unsigned int, 1>,
                                     std::integral_constant<long unsigned int, 2>,
                                     std::integral_constant<long unsigned int, 3>,
                                     std::integral_constant<long unsigned int, 4>,
...
TEST_F(list_test, insert) {
    {
        ...
        constexpr auto expect_true = std::is_same_v<ctl::insert_t<list, pos, float>,
                                                    ctl::list<float, int, char, double, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false = std::is_same_v<ctl::insert_t<list, pos, float>,
                                                     ctl::list<int, float, char, double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false = std::is_same_v<ctl::insert_t<list, pos, float>,
                                                     ctl::list<int, char, float, double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true = std::is_same_v<ctl::insert_t<list, pos, float>,
                                                    ctl::list<int, char, double, float, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false = std::is_same_v<ctl::insert_t<list, pos, float>,
                                                     ctl::list<int, char, double, int, float>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        using list = ctl::list<int, char, double, int>;
        using pos = std::integral_constant<uint32_t, 0>;
        constexpr auto expect_true = std::is_same_v<ctl::insert_t<list, pos, float, void>,
                                                    ctl::list<float, void, int, char, double, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::insert_t<list, pos, float, void>,
                           ctl::list<int, float, void, char, double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::insert_t<list, pos, float, void>,
                           ctl::list<int, char, float, void, double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        using pos = std::integral_constant<uint32_t, 3>;
        constexpr auto expect_true = std::is_same_v<ctl::insert_t<list, pos, float, void>,
                                                    ctl::list<int, char, double, float, void, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::insert_t<list, pos, float, void>,
                           ctl::list<int, char, double, int, float, void>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        using pos = std::integral_constant<uint32_t, 0>;
        constexpr auto expect_true =
            std::is_same_v<ctl::insert_t<list, pos, float, void>, ctl::list<float, void>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::insert_t<list, pos, float, void>, ctl::list<>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, erase) {
    ...
    //   constexpr auto expect_true = std::is_same_v<ctl::erase_t<list, pos, pos>, ctl::list<char,
    //   double, int>>; EXPECT_TRUE(expect_true);

    //   constexpr auto expect_false = std::is_same_v<ctl::insert_t<list, pos, pos>, ctl::list<int,
    //   char, double, int>>; EXPECT_FALSE(expect_false);
    // }

    // {
    //   using list = ctl::list<int, char, double, int>;
    //   using pos = std::integral_constant<uint32_t, 1>;
    //   constexpr auto expect_true = std::is_same_v<ctl::erase_t<list, pos, pos>, ctl::list<int,
    //   double, int>>; EXPECT_TRUE(expect_true);

    //   constexpr auto expect_false = std::is_same_v<ctl::erase_t<list, pos, pos>, ctl::list<int,
    //   char, int>>; EXPECT_FALSE(expect_false);
    // }
    ...
    //   using pos = std::integral_constant<uint32_t, 3>;
    //   constexpr auto expect_true = std::is_same_v<ctl::erase_t<list, pos, pos>, ctl::list<int,
    //   char, double>>; EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::erase_t<list, pos1, pos2>, ctl::list<char, double, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::insert_t<list, pos1, pos2>, ctl::list<double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::erase_t<list, pos1, pos2>, ctl::list<int, double, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::erase_t<list, pos1, pos2>, ctl::list<int, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::erase_t<list, pos1, pos2>, ctl::list<int>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::erase_t<list, pos1, pos2>, ctl::list<double, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::erase_t<list, pos1, pos2>, ctl::list<int, char, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::erase_t<list, pos1, pos2>, ctl::list<int, char>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::erase_t<list, pos1, pos2>, ctl::list<int, char, double>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, replace) {
    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_t<list, int, float>, ctl::list<float, char, double, float>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_t<list, int, float>, ctl::list<float, char, double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_t<list, char, float>, ctl::list<int, float, double, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_t<list, char, float>, ctl::list<int, char, double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_t<list, double, float>, ctl::list<int, char, float, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_t<list, double, float>, ctl::list<int, char, double, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_t<list, int, float>, ctl::list<float>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_t<list, int, float>, ctl::list<int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_t<list, int, float>, ctl::list<float, float, float>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_t<list, int, float>, ctl::list<int, int, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_t<list, char, float>, ctl::list<int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_t<list, char, float>, ctl::list<float>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_t<list, char, float>, ctl::list<int, int, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_t<list, char, float>, ctl::list<float, float, float>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, replace_at) {
    {
        ...
        constexpr auto expect_true = std::is_same_v<ctl::replace_at_t<list, pos, float>,
                                                    ctl::list<float, char, double, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false = std::is_same_v<ctl::replace_at_t<list, pos, float>,
                                                     ctl::list<float, char, double, float>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_at_t<list, pos, float>, ctl::list<int, float, double, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_at_t<list, pos, float>, ctl::list<int, char, float, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true = std::is_same_v<ctl::replace_at_t<list, pos, float>,
                                                    ctl::list<int, char, double, float>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_at_t<list, pos, float>, ctl::list<float>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_at_t<list, pos, float>, ctl::list<int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_at_t<list, pos, float>, ctl::list<float, int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_at_t<list, pos, float>, ctl::list<int, float, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_at_t<list, pos, float>, ctl::list<int, int, float>>;
        EXPECT_TRUE(expect_true);
...
TEST_F(list_test, replace_only_ints) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true = std::is_same_v<ctl::replace_if_t<list, pred_int, float>,
                                                    ctl::list<float, char, double, float>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_if_t<list, pred_int, float>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true = std::is_same_v<
            ctl::replace_if_t<list, pred_int, float>,
            ctl::list<char, float, char, float, double, float, char, float, double, float, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_if_t<list, pred_int, float>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_if_t<list, pred_int, float>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, replace_only_ints_chars) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true = std::is_same_v<ctl::replace_if_t<list, pred_int_char, float>,
                                                    ctl::list<float, float, double, float>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_if_t<list, pred_int_char, float>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_if_t<list, pred_int_char, float>,
                           ctl::list<float, float, float, float, double, float, float, float,
                                     double, float, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_if_t<list, pred_int_char, float>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_if_t<list, pred_int_char, float>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, replace_none) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_if_t<list, pred_empty, float>, list>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_if_t<list, pred_empty, float>, ctl::list<>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::replace_if_t<list, pred_empty, float>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, replace_all) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true = std::is_same_v<ctl::replace_if_t<list, pred_all, float>,
                                                    ctl::list<float, float, float, float>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_if_t<list, pred_all, float>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true = std::is_same_v<
            ctl::replace_if_t<list, pred_all, float>,
            ctl::list<float, float, float, float, float, float, float, float, float, float, float>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_if_t<list, pred_all, float>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_if_t<list, pred_all, float>, ctl::list<float>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, replace_using_quoted_meta_function) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_if_qmf_t<list, quoted_int_char, float>,
                           ctl::list<float, float, double, float>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_if_qmf_t<list, quoted_int_char, float>, list>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::replace_if_qmf_t<list, quoted_int_char, float>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::replace_if_qmf_t<list, quoted_int_char, float>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, rotate_left) {
    {
        ...
        using pos = std::integral_constant<uint32_t, 0>;
        constexpr auto expect_true =
            std::is_same_v<ctl::rotate_left_t<list, pos>, ctl::list<int, char, double, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::rotate_left_t<list, pos>, ctl::list<char, double, int, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::rotate_left_t<list, pos>, ctl::list<double, int, int, char>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::rotate_left_t<list, pos>, ctl::list<int, int, char, double>>;
        EXPECT_FALSE(expect_false);
    }
...
TEST_F(list_test, rotate_right) {
    {
        ...
        using pos = std::integral_constant<uint32_t, 0>;
        constexpr auto expect_true =
            std::is_same_v<ctl::rotate_right_t<list, pos>, ctl::list<int, char, double, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::rotate_right_t<list, pos>, ctl::list<char, double, int, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        using pos = std::integral_constant<uint32_t, 1>;
        constexpr auto expect_true =
            std::is_same_v<ctl::rotate_right_t<list, pos>, ctl::list<int, int, char, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        using pos = std::integral_constant<uint32_t, 2>;
        constexpr auto expect_true =
            std::is_same_v<ctl::rotate_right_t<list, pos>, ctl::list<double, int, int, char>>;
        EXPECT_TRUE(expect_true);
...
TEST_F(list_test, copy_if_only_ints) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::copy_if_t<list, pred_int>, ctl::list<int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true =
            std::is_same_v<ctl::copy_if_t<list, pred_int>, ctl::list<int, int, int, int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::copy_if_t<list, pred_int>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, copy_if_only_ints_chars) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::copy_if_t<list, pred_int_char>, ctl::list<int, char, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true =
            std::is_same_v<ctl::copy_if_t<list, pred_int_char>,
                           ctl::list<char, int, char, int, int, char, int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::copy_if_t<list, pred_int_char>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::copy_if_t<list, pred_int_char>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, copy_if_none) {
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::copy_if_t<list, pred_empty>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, copy_if_all) {
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::copy_if_t<list, pred_all>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, copy_if_using_quoted_meta_function) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::copy_if_qmf_t<list, quoted_int_char>, ctl::list<int, char, int>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::copy_if_qmf_t<list, quoted_int_char>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true =
            std::is_same_v<ctl::copy_if_qmf_t<list, quoted_int_char>,
                           ctl::list<char, int, char, int, int, char, int, int>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::copy_if_qmf_t<list, quoted_int_char>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::copy_if_qmf_t<list, quoted_int_char>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, remove_if_only_ints) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::remove_if_t<list, pred_int>, ctl::list<char, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true =
            std::is_same_v<ctl::remove_if_t<list, pred_int>,
                           ctl::list<char, char, double, char, double, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::remove_if_t<list, pred_int>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, remove_if_only_ints_chars) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::remove_if_t<list, pred_int_char>, ctl::list<double>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true = std::is_same_v<ctl::remove_if_t<list, pred_int_char>,
                                                    ctl::list<double, double, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::remove_if_t<list, pred_int_char>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::remove_if_t<list, pred_int_char>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, remove_if_none) {
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::remove_if_t<list, pred_empty>, ctl::list<>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::remove_if_t<list, pred_empty>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, remove_if_all) {
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::remove_if_t<list, pred_all>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, remove_if_using_quoted_meta_function) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::remove_if_qmf_t<list, quoted_int_char>, ctl::list<double>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::remove_if_qmf_t<list, quoted_int_char>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true = std::is_same_v<ctl::remove_if_qmf_t<list, quoted_int_char>,
                                                    ctl::list<double, double, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::remove_if_qmf_t<list, quoted_int_char>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::remove_if_qmf_t<list, quoted_int_char>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, unique_if_only_ints) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::unique_if_t<list, pred_int>, ctl::list<char, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true =
            std::is_same_v<ctl::unique_if_t<list, pred_int>,
                           ctl::list<char, char, double, char, double, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::unique_if_t<list, pred_int>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, unique_if_only_ints_chars) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::unique_if_t<list, pred_int_char>, ctl::list<double>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true = std::is_same_v<ctl::unique_if_t<list, pred_int_char>,
                                                    ctl::list<double, double, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::unique_if_t<list, pred_int_char>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::unique_if_t<list, pred_int_char>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, unique_if_none) {
    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::unique_if_t<list, pred_empty>, ctl::list<>>;
        EXPECT_FALSE(expect_false);
    }
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::unique_if_t<list, pred_empty>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, unique_if_all) {
...

    {
        ...
        constexpr auto expect_false =
            std::is_same_v<ctl::unique_if_t<list, pred_all>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, unique_if_using_quoted_meta_function) {
    {
        using list = ctl::list<int, char, double, int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::unique_if_qmf_t<list, quoted_int_char>, ctl::list<double>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::unique_if_qmf_t<list, quoted_int_char>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        using list = ctl::list<char, int, char, int, double, int, char, int, double, int, double>;
        constexpr auto expect_true = std::is_same_v<ctl::unique_if_qmf_t<list, quoted_int_char>,
                                                    ctl::list<double, double, double>>;
        EXPECT_TRUE(expect_true);
...

    {
        using list = ctl::list<>;
        constexpr auto expect_true =
            std::is_same_v<ctl::unique_if_qmf_t<list, quoted_int_char>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::unique_if_qmf_t<list, quoted_int_char>, ctl::list<char>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, transform) {
    ...
    {
        constexpr auto expect_true = std::is_same_v<ctl::transform_t<add_pointer_t, list>,
                                                    ctl::list<int*, char*, double*, int*>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_t<add_pointer_t, ctl::list<>>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::transform_t<add_pointer_t, ctl::list<>>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        // constexpr auto expect_true = std::is_same_v<ctl::transform_t<predicate_type, list>,
        // ctl::list<std::integral_constant<bool, true>, std::integral_constant<bool, false>,
        // std::integral_constant<bool, false>, std::integral_constant<bool, true> >>;
        constexpr auto expect_true = std::is_same_v<
            ctl::transform_t<predicate_type, list>,
            ctl::list<std::true_type, std::false_type, std::false_type, std::true_type>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_t<predicate_type, ctl::list<>>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::transform_t<predicate_type, ctl::list<>>, list>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, transform_multi_list) {
    {
        ...
        auto lists_compare =
            ctl::all_of_t<ctl::transform_t<std::is_same, list1, list2>, is_same_indirection>::value;
        EXPECT_TRUE(lists_compare);

        lists_compare =
            ctl::any_of_t<ctl::transform_t<std::is_same, list1, list2>, is_same_indirection>::value;
        EXPECT_TRUE(lists_compare);

        lists_compare = ctl::none_of_t<ctl::transform_t<std::is_same, list1, list2>,
                                       is_same_indirection>::value;
...

    {
        ...
        auto lists_compare = ctl::none_of_t<ctl::transform_t<std::is_same, list1, list2>,
                                            is_same_indirection>::value;
        EXPECT_TRUE(lists_compare);
...

    {
        ...
        auto lists_compare =
            ctl::all_of_t<ctl::transform_qmf_t<ctl::quote<std::is_same>, list1, list2>,
                          is_same_indirection>::value;
        EXPECT_TRUE(lists_compare);

        lists_compare = ctl::any_of_t<ctl::transform_qmf_t<ctl::quote<std::is_same>, list1, list2>,
                                      is_same_indirection>::value;
        EXPECT_TRUE(lists_compare);

        lists_compare = ctl::none_of_t<ctl::transform_qmf_t<ctl::quote<std::is_same>, list1, list2>,
                                       is_same_indirection>::value;
        EXPECT_FALSE(lists_compare);
    }
...

    {
        ...
        auto expect_true = std::is_same_v<
            ctl::transform_t<std::tuple, type1, type2, type3>,
            ctl::list<std::tuple<int, char, double>, std::tuple<char, double, float>>>;
        EXPECT_TRUE(expect_true);

        auto expect_false =
            std::is_same_v<ctl::transform_t<std::tuple, type1, type2, type3>,
                           ctl::list<ctl::list<int, char, double>, ctl::list<char, double, float>>>;
        EXPECT_FALSE(expect_false);

        expect_false = std::is_same_v<
            ctl::transform_t<std::tuple, type1, type2, type3>,
            std::tuple<ctl::list<int, char, double>, ctl::list<char, double, float>>>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, transform_quoted_meta_function) {
    ...
    {
        constexpr auto expect_true = std::is_same_v<ctl::transform_qmf_t<quoted_add_ptr, list>,
                                                    ctl::list<int*, char*, double*, int*>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::transform_qmf_t<quoted_add_ptr, list>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_qmf_t<quoted_add_ptr, ctl::list<>>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::transform_qmf_t<quoted_add_ptr, ctl::list<>>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        constexpr auto expect_true = std::is_same_v<
            ctl::transform_qmf_t<quoted_pred_type, list>,
            ctl::list<std::true_type, std::false_type, std::false_type, std::true_type>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::transform_qmf_t<quoted_pred_type, list>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_qmf_t<quoted_pred_type, ctl::list<>>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::transform_qmf_t<quoted_pred_type, ctl::list<>>, list>;
        EXPECT_FALSE(expect_false);
    }
}
...
TEST_F(list_test, transform_if) {
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_if_t<pred_int, add_pointer_t, list>,
                           ctl::list<int*, char, double, int*>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_if_t<pred_int_char, add_pointer_t, list>,
                           ctl::list<int*, char*, double, int*>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_if_t<pred_empty, add_pointer_t, list>, list>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_if_t<pred_all, add_pointer_t, list>,
                           ctl::list<int*, char*, double*, int*>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::transform_if_t<pred_int_char, add_pointer_t, list>, list>;
        EXPECT_FALSE(expect_false);
    }

    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_if_qmf_t<quoted_int_char, quoted_add_ptr, list>,
                           ctl::list<int*, char*, double, int*>>;
        EXPECT_TRUE(expect_true);
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_if_t<pred_int, add_pointer_t, ctl::list<>>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::transform_if_t<pred_int, add_pointer_t, ctl::list<>>,
                           ctl::list<int*>>;
        EXPECT_FALSE(expect_false);
    }
    ...
    {
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_if_t<pred_int, predicate_type, ctl::list<>>, ctl::list<>>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::transform_if_t<pred_int, predicate_type, ctl::list<>>,
                           ctl::list<int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_if_t<first_is_void, second, L1, L2>, expected>;
        EXPECT_TRUE(expect_true);

        constexpr auto expect_false =
            std::is_same_v<ctl::transform_if_t<first_is_void, second, L1, L2>,
                           std::tuple<void, int, float, void, int>>;
        EXPECT_FALSE(expect_false);
    }

    {
        ...
        using expected = std::tuple<char[1], int, float, char[4], int>;
        constexpr auto expect_true =
            std::is_same_v<ctl::transform_if_qmf_t<quoted_first_is_void, quoted_second, L1, L2>,
                           expected>;
        EXPECT_TRUE(expect_true);
...
TEST_F(list_test, sort) {
    ...
    {
        using nums = ctl::from_integer_sequence_t<
            std::integer_sequence<uint32_t, 13, 41, 450, 4562, 121, 34, 553, 2, 1, 6, 5689>>;
        using expected_nums = ctl::from_integer_sequence_t<
            std::integer_sequence<uint32_t, 1, 2, 6, 13, 34, 41, 121, 450, 553, 4562, 5689>>;
